  ...
  switch (event.type) {
    ...
    //   break;
      ...
      case 'checkout.session.completed':
        ...
        sendMail(user.email,`${user.firstname} ${user.lastname}`,'Confirmation du paiement de la commande',`Votre commande a bien été enregistrée. Votre numéro de commande est le ${order.order_id}. Télècharger votre facture ici: ${invoice.invoice_pdf}`);
        break;
